...
#include "..\Helpers\MeshProcessingHelper.h"
...
public:
	...
	static PackedCommonVertex MakePackedVertex(const FbxVector4& vControlPoint, const FbxVector4& vNormalVector, const FbxVector2& UVmap1, double m_factor_to_meters)
	{
		...
		destVertexRef.uv.y = static_cast <float>(1.0 - UVmap1.mData[1]);
	...
	static bool MakeUnindexPackedMesh(fbxsdk::FbxScene* poFbxScene, fbxsdk::FbxMesh* poFbxMesh, PackedMesh& destMesh, std::vector<int>& vertexToControlPoint)
	{
		...
		// TODO: REMOVE THESE 2 LINES, unless you want to transform vertices?
		...
		{			
			...
			{		
				auto DEBUG__testVertexIndex = (faceIndex * 3) + faceCorner; // TODO: check if this can replace "vertex_index", and if so decide if it SHOULD
				...
				**********************************************************************************/
				...
				FbxVector4 vControlPoint = pControlPoints[controlPointIndex];
				
				// -- Vertex to controlpoint mapper, used for assiging control-point depedent atrributes to multiple vertices				
				vertexToControlPoint.push_back(controlPointIndex); 
				...
				/********************************************************************************
					NORMALS:  transformation  + assign normals
				*********************************************************************************/	
				...
				*********************************************************************************/
				...
				//FbxVector2 v2UVPoly;
				//poFbxMesh->GetPolygonVertexUV(faceIndex, faceCorner, textureUVMaps.begin()->first.c_str(), v2UVPoly, mapped);
				...
				*********************************************************************************/
				...
				destMesh.indices[vertex_index] = static_cast<uint16_t>(vertex_index);
