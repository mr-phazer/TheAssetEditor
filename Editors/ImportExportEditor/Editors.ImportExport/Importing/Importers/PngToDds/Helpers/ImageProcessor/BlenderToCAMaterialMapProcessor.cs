...
{
    public class BlenderToCAMaterialMapProcessor : IImageProcessor
    {
        public ScratchImage Transform(ScratchImage scratchImage)
        {
            ...
            // create a new scratch image with the same dimensions and format as the input image
            //var outScratchImage = 
            //    TexHelper.Instance.Initialize2D(
