...
namespace AssetManagement.Geometry.MeshProcessing.Common
{
    public class CommonWeightProcessor
    {
        ...
        public static void NormalizeVertexWeights(CommonVertex vertex)
        {
            ...
            var scaleFactor = 1.0f / weightSum;
        ...
        class SortVertexWeight
        {
            public uint BoneIndex { set; get;  }
        ...
        {
            var influences = new List<SortVertexWeight>(4)
                {
                    new SortVertexWeight(),
                    new SortVertexWeight(),
                    new SortVertexWeight(),
                    new SortVertexWeight(),
                };
