...
using AssetManagement.Geometry.Strategies.Fbx.Models;

namespace AssetManagement.Geometry.Strategies.Fbx.ExportDIalog.ViewModels
{
    public class FBXSettingsViewModel : NotifyPropertyChangedImpl
    {
        ...
        {
            var outSettingsModel = new FbxSettingsModel();
